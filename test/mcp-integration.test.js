...
test("stdio transport discovers seven tools and runs the baseline workflow", async (t) => {
...
test("HTTP transport discovers seven tools and runs the baseline workflow without leaking route", async (t) => {
